...
frappe.ui.form.on('Passport Movement', {
    ...
    employee(frm) {
        ...
        frappe.call({
            method: 'rental_management.passport_management.doctype.passport_movement.passport_movement.get_employee_passport',
...
function _check_active_in(frm) {
    frappe.call({
        method: 'rental_management.passport_management.doctype.passport_movement.passport_movement.get_active_in_record',
        args: { employee: frm.doc.employee },
        callback(r) {
            if (!r.message) {
                frappe.msgprint({
