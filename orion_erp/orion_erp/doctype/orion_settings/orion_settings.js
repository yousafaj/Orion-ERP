...
frappe.ui.form.on("Orion Settings", {
	trigger_oe_cron(frm) {
        ...
        frappe.call({
            method: "orion_erp.orion_erp.doctype.employee_deduction.employee_deduction.run_deduction_cron",
            freeze: true,
    ...
    trigger_additional_deduction_for_office_employee(frm) {
		...
		frappe.call({
			method: "orion_erp.orion_erp.doctype.employee_deduction.employee_deduction.run_deduction_manual",
			args: {
