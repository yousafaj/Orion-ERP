...
class EmployeeCertificateNotificationSettings(Document):
	...
	if TYPE_CHECKING:
		...
		from orion_erp.orion_erp.doctype.employee_certificate_notification_detail.employee_certificate_notification_detail import EmployeeCertificateNotificationDetail
