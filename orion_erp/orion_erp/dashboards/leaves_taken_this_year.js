    ...
    <p style="margin:0;color:#9ca3af;font-size:14px">You have not taken any leave so far this year.</p>
        ...
        leave_data.forEach((row, idx) => {
            ...
            table_rows += [
                ...
                '<span style="display:inline-block;padding:3px 12px;border-radius:20px;font-size:12px;font-weight:700;color:#fff;background:linear-gradient(135deg,#16a34a,#15803d);box-shadow:0 2px 6px rgba(22,163,74,0.25);min-width:50px">',
                days, ' Day', (days !== 1 ? 's' : ''),
                '</span></td></tr>'
            ].join('');
        });
...
<div class="dashboard-body">
    <div style="background:linear-gradient(135deg,#1e40af,#2563eb,#3b82f6);border-radius:12px 12px 0 0;padding:12px 20px;display:flex;align-items:center;gap:12px;box-shadow:0 4px 16px rgba(37,99,235,0.25)">
        ...
        <div style="flex:1">
            <div style="font-size:16px;font-weight:700;color:#fff;letter-spacing:-0.3px">Leaves Taken This Year</div>
            <div style="font-size:12px;color:rgba(255,255,255,0.75);margin-top:0">Leave Consumption Summary</div>
        </div>
    ...
    <div class="kpi-grid">
        ...
        <div class="kpi-card" style="display:flex;align-items:center;gap:12px;padding:10px 14px;background:#eff6ff;border-radius:10px;border:1px solid #bfdbfe;transition:all 0.25s">
            ...
            <div>
                <div style="font-size:10px;font-weight:600;color:#6b7280;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:1px">Current Leave Year</div>
                <div style="font-size:14px;font-weight:700;color:#1d4ed8;line-height:1;margin-bottom:1px">${current_year}</div>
                <div style="font-size:11px;color:#6b7280;margin-top:0">Calendar Year</div>
            </div>
        </div>
        ...
        <div class="kpi-card" style="display:flex;align-items:center;gap:12px;padding:10px 14px;background:#f0fdf4;border-radius:10px;border:1px solid #bbf7d0;transition:all 0.25s">
            ...
            <div>
                <div style="font-size:10px;font-weight:600;color:#6b7280;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:1px">Leave Types Used</div>
                <div style="font-size:22px;font-weight:800;color:#15803d;line-height:1">${total_types}</div>
                <div style="font-size:11px;color:#6b7280;margin-top:0">This Year</div>
            </div>
        </div>
        ...
        <div class="kpi-card" style="display:flex;align-items:center;gap:12px;padding:10px 14px;background:#fafafa;border-radius:10px;border:1px solid #e5e7eb;transition:all 0.25s">
            <div style="display:flex;align-items:center;justify-content:center;width:36px;height:36px;border-radius:8px;background:linear-gradient(135deg,#f3f4f6,#f9fafb);color:#6b7280;font-size:15px;flex-shrink:0"><i class="fa fa-calculator"></i></div>
            <div>
                <div style="font-size:10px;font-weight:600;color:#6b7280;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:1px">Total Days Taken</div>
                <div style="font-size:22px;font-weight:800;color:#1f2937;line-height:1">${total_days_taken}</div>
                <div style="font-size:11px;color:#6b7280;margin-top:0">Days Consumed</div>
            </div>
        </div>
    </div>
    ...
    <div style="background:#fff;border:1px solid #e5e7eb;border-top:none;border-radius:0 0 12px 12px;overflow:hidden;box-shadow:0 4px 12px rgba(0,0,0,.04)">
        <div style="display:flex;align-items:center;padding:10px 16px;background:#f8fafc;border-bottom:1px solid #e5e7eb">
            <div style="font-size:13px;font-weight:700;color:#374151;display:flex;align-items:center;gap:6px">
                <i class="fa fa-list-alt" style="color:#2563eb;font-size:12px"></i> Leave Breakdown
            ...
            <table style="width:100%;border-collapse:collapse;font-size:13px">
                <thead>
                    <tr style="background:#f1f5f9;position:sticky;top:0;z-index:10">
                        ...
                        <th style="padding:10px 16px;text-align:center;font-size:11px;font-weight:700;color:#374151;text-transform:uppercase;letter-spacing:0.5px;border-bottom:2px solid #e2e8f0;width:150px">Days Taken</th>
                    </tr>
                </thead>
