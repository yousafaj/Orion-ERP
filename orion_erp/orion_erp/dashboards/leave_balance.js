    ...
    try {
        ...
        leave_data.forEach((row, idx) => {
            ...
            table_rows += [
                ...
                '<td style="padding:14px 20px;font-size:14px;font-weight:500;color:#1f2937;border-bottom:1px solid #f0f0f0">',
                escaped_type,
                '</td>',
                '<td style="padding:14px 20px;text-align:center;border-bottom:1px solid #f0f0f0">',
                '<span style="display:inline-block;padding:4px 16px;border-radius:20px;font-size:13px;font-weight:700;color:#fff;background:',
                (balance > 0 ? 'linear-gradient(135deg,#16a34a,#15803d)' : '#9ca3af'),
                ';box-shadow:0 2px 6px rgba(22,163,74,0.25);min-width:60px">',
        ...
        root_element.innerHTML = [
            ...
            '<div style="flex:1">',
            '<div style="font-size:20px;font-weight:700;color:#fff;letter-spacing:-0.3px">My Leave Balance</div>',
            '<div style="font-size:13px;color:rgba(255,255,255,0.75);margin-top:2px">Employee Leave Summary Dashboard</div>',
            '</div>',
            '<div class="header-actions">',
            '<button id="openLeaveBtn" style="display:flex;align-items:center;gap:6px;padding:8px 18px;border:none;border-radius:8px;background:rgba(255,255,255,0.2);color:#fff;font-size:13px;font-weight:600;cursor:pointer;transition:all 0.2s;backdrop-filter:blur(4px);border:1px solid rgba(255,255,255,0.15)">',
            ...
            '<i class="fa fa-refresh" style="font-size:12px"></i> Refresh</button>',
            '</div></div>',

            '<div class="kpi-grid">',

            '<div style="display:flex;align-items:center;gap:16px;padding:18px 20px;background:#f8fafc;border-radius:10px;border:1px solid #e5e7eb;transition:all 0.25s" class="kpi-card">',
            ...
            '<div style="display:flex;align-items:center;gap:16px;padding:18px 20px;background:#f0fdf4;border-radius:10px;border:1px solid #bbf7d0;transition:all 0.25s" class="kpi-card">',
            ...
            '<div><div style="font-size:11px;font-weight:600;color:#6b7280;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:2px">Leave Types</div>',
            '<div style="font-size:28px;font-weight:800;color:#15803d;line-height:1.1">', total_types, '</div>',
            '<div style="font-size:12px;color:#6b7280;margin-top:2px">Active Allocations</div></div></div>',

            '<div style="display:flex;align-items:center;gap:16px;padding:18px 20px;background:#eff6ff;border-radius:10px;border:1px solid #bfdbfe;transition:all 0.25s" class="kpi-card">',
            ...
            '<div><div style="font-size:11px;font-weight:600;color:#6b7280;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:2px">Total Balance</div>',
            '<div style="font-size:28px;font-weight:800;color:#1d4ed8;line-height:1.1">', total_balance, '</div>',
            '<div style="font-size:12px;color:#6b7280;margin-top:2px">Days Available</div></div></div>',
