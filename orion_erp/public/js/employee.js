...
frappe.ui.form.on('Employee', {
            ...
            if (field.df.fieldtype === "Link" && field.df.options === "User") {
                ...
                frm.set_query(fieldname, function () {
                    return {
                        ...
                        query: "orion_erp.doctype.employee.user_by_employee"
                    };
                });
    ...
    refresh: function(frm) {
        ...
        frappe.call({
            method: "orion_erp.doctype.employee.get_manual_paid_lock_date",
            callback: function(r) {
...
function toggle_salary_structure(frm) {
    ...
    frappe.call({
        method: "orion_erp.doctype.employee.check_salary_structure_assignment",
        args: {
