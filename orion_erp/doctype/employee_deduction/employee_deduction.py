...
class EmployeeDeduction(Document):
	...
	if TYPE_CHECKING:
		...
		from orion_erp.doctype.employee_deduction_detail.employee_deduction_detail import EmployeeDeductionDetail
		from orion_erp.doctype.outstanding_employee_deduction_detail.outstanding_employee_deduction_detail import OutstandingEmployeeDeductionDetail
