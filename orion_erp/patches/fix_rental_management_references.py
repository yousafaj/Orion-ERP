...
def execute():
    ...
    replacements = [
        ("rental_management.rental_management", "orion_erp.orion_erp"),
    ...
    force_fix_queries = [
        (
            ...
            "orion_erp.orion_erp.validations.number_cards.expire_in_30_days"
        ),
        (
            "rental_management.rental_management.validations.number_cards.expire_in_60_days",
            "orion_erp.orion_erp.validations.number_cards.expire_in_60_days"
        ),
        (
            "rental_management.rental_management.validations.number_cards.expired",
            "orion_erp.orion_erp.validations.number_cards.expired"
        ),
        (
